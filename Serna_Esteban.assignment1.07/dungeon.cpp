...
static int32_t in_room(dungeon_t *d, int16_t y, int16_t x)
{
  uint i;
...
static int smooth_hardness(dungeon_t *d)
{
  ...
  int8_t hardness[DUNGEON_Y][DUNGEON_X];
...
int32_t calculate_dungeon_size(dungeon_t *d)
{
...
int calculate_num_rooms(int32_t dungeon_bytes)
{
