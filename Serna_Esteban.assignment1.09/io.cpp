...
void equipt_items(dungeon_t *d, int key){
  int i = 0;
  // int quit;
  int x=20;
  int y=3;
  while(getch() != 27 ){
    // quit =  0;
      ...
      switch(key){
          case 0:
          if(!d->PC->equipment[0]){
            d->PC->equipment[0] = d->PC->backpack[key];
            mvprintw(y+i,x+3,d->PC->equipment[0]->get_name());
            d->PC->backpack[0]= NULL;
            // quit =1;
          }
          break;
          ...
          case 1:
          if(!d->PC->equipment[1]){
            d->PC->equipment[1] = d->PC->backpack[key];
            mvprintw(y+i,x+3,d->PC->equipment[1]->get_name());
            d->PC->backpack[1]= NULL;
            // quit =1;
          }
          break;
          ...
          case 2:
          if(!d->PC->equipment[2]){
            d->PC->equipment[2] = d->PC->backpack[key];
            mvprintw(y+i,x+3,d->PC->equipment[2]->get_name());
            d->PC->backpack[2]= NULL;
            // quit =1;
          ...
          case 3:
          if(!d->PC->equipment[3]){
            d->PC->equipment[3] = d->PC->backpack[key];
            mvprintw(y+i,x+3,d->PC->equipment[3]->get_name());
            d->PC->backpack[3]= NULL;
            // quit =1;
          }
          break;
          ...
          case 4:
          if(!d->PC->equipment[4]){
            d->PC->equipment[4] = d->PC->backpack[key];
            mvprintw(y+i,x+3,d->PC->equipment[4]->get_name());
            d->PC->backpack[4]= NULL;
            // quit =1;
          }
          break;
          ...
          case 5:
          if(!d->PC->equipment[5]){
            d->PC->equipment[5] = d->PC->backpack[key];
            mvprintw(y+i,x+3,d->PC->equipment[5]->get_name());
            d->PC->backpack[5]= NULL;
            // quit =1;
          }
          break;
          ...
          case 6:
          if(!d->PC->equipment[6]){
            d->PC->equipment[6] = d->PC->backpack[key];
            mvprintw(y+i,x+3,d->PC->equipment[6]->get_name());
            d->PC->backpack[6]= NULL;
            // quit =1;
          }
          break;
          ...
          case 7:
          if(!d->PC->equipment[7]){
            d->PC->equipment[7] = d->PC->backpack[key];
            mvprintw(y+i,x+3,d->PC->equipment[7]->get_name());
            d->PC->backpack[7]= NULL;
            // quit =1;
          }
          break;
          ...
          case 8:
          if(!d->PC->equipment[8]){
            d->PC->equipment[8] = d->PC->backpack[key];
            mvprintw(y+i,x+3,d->PC->equipment[8]->get_name());
            d->PC->backpack[8]= NULL;
            // quit =1;
          }
          break;
          ...
          case 9:
          if(!d->PC->equipment[9]){
            d->PC->equipment[9] = d->PC->backpack[key];
            mvprintw(y+i,x+3,d->PC->equipment[9]->get_name());
            d->PC->backpack[9]= NULL;
            // quit =1;
          }
          break;
          ...
          if(!d->PC->equipment[10]){
            d->PC->equipment[10] = d->PC->backpack[key];
            mvprintw(y+i,x+3,d->PC->equipment[10]->get_name());
            d->PC->backpack[10]= NULL;
              // quit =1;
          }
          break;
...
void unequipt(dungeon_t *d, int key){
  int i = 0;
  // int quit;
  int x=20;
  int y=3;
  while(getch() != 27 ){
      switch(key){
          case 0:
          if(!d->PC->backpack[0]){
            d->PC->backpack[0] = d->PC->equipment[key];
            mvprintw(y+i,x+3,d->PC->backpack[0]->get_name());
            d->PC->equipment[0]= NULL;
            // quit =1;
          }
          break;
          ...
          case 1:
          if(!d->PC->backpack[1]){
            d->PC->backpack[1] = d->PC->equipment[key];
            mvprintw(y+i,x+3,d->PC->backpack[1]->get_name());
            d->PC->equipment[1]= NULL;
            // quit =1;
          }
          break;
          ...
          case 2:
          if(!d->PC->backpack[2]){
            d->PC->backpack[2] = d->PC->equipment[key];
            mvprintw(y+i,x+3,d->PC->backpack[2]->get_name());
            d->PC->equipment[2]= NULL;
            // quit =1;
          ...
          case 3:
          if(!d->PC->backpack[3]){
            d->PC->backpack[3] = d->PC->equipment[key];
            mvprintw(y+i,x+3,d->PC->backpack[3]->get_name());
            d->PC->equipment[3]= NULL;
            // quit =1;
          }
          break;
          ...
          case 4:
          if(!d->PC->backpack[4]){
            d->PC->backpack[4] = d->PC->equipment[key];
            mvprintw(y+i,x+3,d->PC->backpack[4]->get_name());
            d->PC->equipment[4]= NULL;
            // quit =1;
          }
          break;
          ...
          case 5:
          if(!d->PC->backpack[5]){
            d->PC->backpack[5] = d->PC->equipment[key];
            mvprintw(y+i,x+3,d->PC->backpack[5]->get_name());
            d->PC->equipment[5]= NULL;
            // quit =1;
          }
          break;
          ...
          case 6:
          if(!d->PC->backpack[6]){
            d->PC->backpack[6] = d->PC->equipment[key];
            mvprintw(y+i,x+3,d->PC->backpack[6]->get_name());
            d->PC->equipment[6]= NULL;
            // quit =1;
          }
          break;
          ...
          case 7:
          if(!d->PC->backpack[7]){
            d->PC->backpack[7] = d->PC->equipment[key];
            mvprintw(y+i,x+3,d->PC->backpack[7]->get_name());
            d->PC->equipment[7]= NULL;
            // quit =1;
          }
          break;
          ...
          case 8:
          if(!d->PC->backpack[8]){
            d->PC->backpack[8] = d->PC->equipment[key];
            mvprintw(y+i,x+3,d->PC->backpack[8]->get_name());
            d->PC->equipment[8]= NULL;
            // quit =1;
          }
          break;
          ...
          case 9:
          if(!d->PC->backpack[9]){
            d->PC->backpack[9] = d->PC->equipment[key];
            mvprintw(y+i,x+3,d->PC->backpack[9]->get_name());
            d->PC->equipment[9]= NULL;
            // quit =1;
          }
          break;
          ...
          if(!d->PC->backpack[10]){
            d->PC->equipment[10] = d->PC->backpack[key];
            mvprintw(y+i,x+3,d->PC->backpack[10]->get_name());
            d->PC->equipment[10]= NULL;
              // quit =1;
          }
          break;
...
void io_display_backpack(dungeon_t *d){
  // clear();
  int i;
  int x = 40;
  int y = 3;
  ...
  for(i = 0;i < 10 ;i++){
    ...
    mvprintw(1,40,"Nap Sack!");
    lis = '0' + i;
    mvaddch(y+i,x,lis);
    mvprintw(y+i,x+1, ": ");

    if(d->PC->backpack[i] != NULL){
    mvprintw(y+i,x+3,d->PC->backpack[i]->get_name());
    }
  }
  refresh();
  getch();
...
void io_display_equipted(dungeon_t *d){
  clear();
  int i;
  int x = 40;
  int y = 3;
  // char lis;
   std::string name[] ={"Helmet", "Armor", "Offhand", "Wepon", "Cloak", "Ranged",
                  "Gloves", "Boots", "Amulet", "Light", "Ring1", "Ring2" };
  for(i = 0;i < 12 ;i++){

    mvprintw(1,40,"Equipment!");
    // lis = '0' + i;
    mvaddstr(y+i,x,name[i].c_str());
    mvprintw(y+i,x+7, ": ");

    if(d->PC->equipment[i] != NULL){
    mvprintw(y+i,x+10,d->PC->equipment[i]->get_name());
  }else{
    mvaddstr(y+i,x,name[i].c_str());
...
// voidio_delete(dungeon_t *d){
//
// }



void io_inspect(dungeon_t *d){
  int key = getch();

  if(d->PC->backpack[key-'0'] != NULL){
    clear();
    printw("%s\n", d->PC->backpack[key-'0']->get_description());
  }
}
...
void io_handle_input(dungeon_t *d)
{
  ...
  do {
    ...
    case 'Q':
      ...
      break;
      case 'i':
      io_display_backpack(d);
      break;
      case 'e':
      io_display_equipted(d);
      break;
      case 'w':
      io_display_backpack(d);
      wear_items(d);
