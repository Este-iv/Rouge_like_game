        ...
        mvaddch(y + 1, x,
                character_get_symbol(d->character_map[d->io_offset[dim_y] + y]
                  ...
                  attroff(COLOR_PAIR(d->character_map[d->io_offset[dim_y] + y]
                                                    [d->io_offset[dim_x] + x]->color));
                  // add if else statement here for the object.
      } else if (d->object_map[d->io_offset[dim_y] + y]
                            [d->io_offset[dim_x] + x] &&
            (can_see(d,
                    character_get_pos(d->PC),
                    obj_pos(d->object_map[d->io_offset[dim_y] + y]
                                                      [d->io_offset[dim_x] + x]),
                    1)|| d->object_map[d->io_offset[dim_y] + y]
                                          [d->io_offset[dim_x] + x]->io==1)) {
